...
namespace AG.Collections.Concurrent.Benchmarks.Experimental
{
    // A cheap attempt at a concurrent hash set
    // I wouldn't call this slim but that's what I came up with at the time
